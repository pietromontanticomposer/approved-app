...
"[project]/app/components/SupabaseSyncBridge.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SupabaseSyncBridge() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        window.supabase = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"];
        window.SupabaseSync = {
            async saveProject (project) {
                try {
                    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("projects").upsert({
                        id: project.id,
                        name: project.name,
            ...
            async loadProjects () {
                try {
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("projects").select(`id, name, description, created_at, updated_at, cues(id, project_id, index_in_project, original_name, name, display_name, status, versions(id, cue_id, index_in_cue, status, media_type, media_storage_path, media_url, media_original_name, media_display_name, media_duration, media_thumbnail_path, media_thumbnail_url, media_waveform_data))`).order("created_at", {
                        ascending: true
                    });
                    if (error) throw error;
            ...
            async saveCue (projectId, cue) {
                try {
                    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("cues").upsert({
                        id: cue.id,
            ...
            async saveVersion (cueId, version) {
                try {
                    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("versions").upsert({
                        id: version.id,
                        cue_id: cueId,
            ...
            async saveVersionFile (versionId, file) {
                try {
                    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("version_files").upsert({
                        id: file.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7483bde5._.js.map