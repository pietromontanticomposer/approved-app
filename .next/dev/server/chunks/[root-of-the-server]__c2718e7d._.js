...
async function POST(req) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].storage.from(STORAGE_BUCKET).upload(path, buffer, {
            contentType,
            upsert: false
        });
        if (error) {
        ...
        // Generate signed URL
        const { data: signedData, error: signError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].storage.from(STORAGE_BUCKET).createSignedUrl(data.path, SIGNED_URL_TTL_SECONDS);
        if (signError) {
            console.warn("[POST /api/upload] Signed URL error (using public URL):", signError);
            // Fallback to public URL
            const { data: publicData } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].storage.from(STORAGE_BUCKET).getPublicUrl(data.path);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                path: data.path,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2718e7d._.js.map