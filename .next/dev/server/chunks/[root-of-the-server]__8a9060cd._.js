...
"[project]/app/api/invites/accept/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!inviteToken) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].rpc('accept_invite', {
            invite_token: inviteToken,
            accepting_user_id: actorId
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8a9060cd._.js.map