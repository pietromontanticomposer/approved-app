...
async function GET(req) {
    try {
        ...
        if (actorId) {
            const resolved = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actorResolver$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveActorId"])(actorId);
        ...
        if (isDebug) respBody['__debug'] = {
            resolved_actor_id: null
        };
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(respBody, {
            status: 200,
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__42486942._.js.map