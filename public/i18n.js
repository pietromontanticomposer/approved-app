...
(function() {
  ...
  const translations = {
    en: {
      ...
      'review.approveCta': 'Approve',
      'review.requestChangesCta': 'Request changes',
      'review.confirmReviewCompleteTitle': 'Confirm',
      'review.confirmReviewCompleteMessage': 'Are you sure you\'re done commenting on this version?',
      'review.confirmReviewCompleteBtn': 'Yes, I\'m done',
      'review.confirmApproveTitle': 'Confirm approval',
      'review.confirmApproveMessage': 'Are you sure you want to approve this version?',
      'review.confirmApproveBtn': 'Yes, approve',
    ...
    it: {
      ...
      'review.startRevisionCta': 'Start revision',
      'review.approveCta': 'Approva',
      'review.requestChangesCta': 'Richiedi modifiche',
      'review.confirmReviewCompleteTitle': 'Conferma',
      'review.confirmReviewCompleteMessage': 'Sei sicuro di aver finito di commentare questa versione?',
      'review.confirmReviewCompleteBtn': 'Sì, ho finito',
      'review.confirmApproveTitle': 'Conferma approvazione',
      'review.confirmApproveMessage': 'Sei sicuro di voler approvare questa versione?',
      'review.confirmApproveBtn': 'Sì, approva',
