...
(function() {
  ...
  const translations = {
    en: {
      ...
      'upload.videoQualityTitle': 'Video quality',
      'upload.videoQualityHint': 'For faster review, we recommend lower video quality. Audio stays at original quality.',
      'upload.qualityOriginal': 'Original',
      'upload.quality720': '720p',
      'upload.quality480': '480p',
      'upload.compressing': 'Compressing video…',
      'upload.rememberChoice': 'Remember my choice',
      'upload.uploadBtn': 'Upload',
      'upload.videoQualityLabel': 'Video:',
      'upload.changeQuality': 'Change',
      ...
      'review.messageCompleted': 'Review completed. New top-level comments are closed.',
      ...
      'comments.replyCancel': 'Cancel reply',
      'comments.replyingTo': 'Replying to {author} · {time}',
      'comments.replyPlaceholder': 'Reply to {author}...',
      'comments.replySelectPlaceholder': 'Select a comment to reply...',
      'comments.replyOwnerOnlyPlaceholder': 'Comments are closed. You can only reply to owner responses.',
      'comments.replyOnlyInternalMessage': 'New comments are closed for this version. You can still reply to existing comments.',
      'comments.replyOnlyOwnerMessage': 'You are done commenting on this version. You can only reply to the project owner responses.',
      'comments.ownerBadge': 'Owner',
      'comments.send': 'Send',
    ...
    it: {
      ...
      'upload.media': 'Media',
      'upload.cinema': 'Cinema',
      'upload.videoQualityTitle': 'Qualità video',
      'upload.videoQualityHint': 'Per una revisione più veloce, consigliamo una qualità video più bassa. L\'audio resta alla qualità originale.',
      'upload.qualityOriginal': 'Originale',
      'upload.quality720': '720p',
      'upload.quality480': '480p',
      'upload.compressing': 'Compressione video…',
      'upload.rememberChoice': 'Ricorda la mia scelta',
      'upload.uploadBtn': 'Carica',
      'upload.videoQualityLabel': 'Video:',
      'upload.changeQuality': 'Modifica',
      ...
      'review.messageCompleted': 'Review completata. I nuovi commenti sono chiusi.',
      ...
      'comments.replyAction': 'Rispondi',
      'comments.replyCancel': 'Annulla risposta',
      'comments.replyingTo': 'Risposta a {author} · {time}',
      'comments.replyPlaceholder': 'Rispondi a {author}...',
      'comments.replySelectPlaceholder': 'Seleziona un commento a cui rispondere...',
      'comments.replyOwnerOnlyPlaceholder': 'Commenti chiusi. Puoi rispondere solo alle risposte del proprietario.',
      'comments.replyOnlyInternalMessage': 'I nuovi commenti sono chiusi per questa versione. Puoi ancora rispondere ai commenti esistenti.',
      'comments.replyOnlyOwnerMessage': 'Hai finito di commentare questa versione. Puoi solo rispondere alle risposte del proprietario.',
      'comments.ownerBadge': 'Proprietario',
      'comments.send': 'Invia',
