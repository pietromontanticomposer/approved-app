...
export default function LegacyPage() {
  return (
    <>
      ...
      {/* WaveSurfer da CDN, se ti serve ancora */}
      <Script
        src="https://unpkg.com/wavesurfer.js@6.6.4/dist/wavesurfer.min.js"
        strategy="afterInteractive"
      />
      {/* tuo JS CodePen portato in /public */}
      <Script src="/approved-legacy.js" strategy="afterInteractive" />
    </>
  );
}
